...
import { getBestProductsData, postProductsData } from "../Redux/action";
...
export const Slider3=()=>{
    ...
    const products=useSelector((state)=>state.productsofbestsellers)
        ...
        products.map((item)=>(
            <div className="div" key={item.id}>
                <div className="slider3_imgdiv">
                   <img src={item.image} alt="" style={{width:"86%",height:"250px"}} />
                </div>
                <div >
