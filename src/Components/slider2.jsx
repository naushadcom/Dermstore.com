...
import {getProductsData, postProductsData} from "../Redux/action"
...
const products=useSelector((state)=>state.productsofskinMedica)
...
dispatch(getProductsData())
    ...
    <p style={{textAlign: "center",margin:"20px 0px"}}>Save on top skin care formulas rooted in science and created by dermatologists. Plus, receive a Skinmedica Vitamin C+E Complex 0.25 oz ($29 value) when you spend $160 or more on the brand.</p>
              ...
              <div className="div" key={item.id}>
                <div className="img_div">
                  <img src={item.image} alt="" style={{width:"100%",height:"200px"}}/>
                   ...
                   <p style={{fontSize:"14px",}}>Reviews:{item.reviews}</p>
                   <p style={{fontSize:"14px",textDecoration:"line-through"}}>MSRP:${item.MSRP}</p>
