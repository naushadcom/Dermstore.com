      ...
      <div className="header">
        <div className="row1">
          ...
          <div className="search">
            ...
            <div style={{ marginLeft: "44%", marginTop: "11%" }}></div>
          </div>
          <div className="accdropdown">
            ...
            <DIV height="400px" width="250%" top="40" marginTop="30%">
              ...
              <Link to="/signup">
                <button className="butt2" style={{ cursor: "pointer" }}>
                  Register
                </button>
              </Link>
              <p>My Favourites</p>
        ...
        <div className="header2">
          <div className="row2">
            ...
            <Link to="bestsellers" className="Linkcss">
              BestSellers
            </Link>
            <Link to="/skincare" className="Linkcss">
              SkinCare
            </Link>
            <Link to="" className="Linkcss">
              Makeup
            </Link>
            <Link to="/haircare" className="Linkcss">
              Hair Care
            </Link>
            <Link to="" className="Linkcss">
              Bath & Body
            ...
            <Link to="/trending" className="Linkcss">
              New
            </Link>
            <Link to="" className="Linkcss">
              Skin101
      ...
      <div className="row3">
        <div>
          ...
          <LocalShippingOutlinedIcon
              style={{ height: "30px", width: "50px", marginTop: "10%" }}
            />
          </div>
          <div>
            <Link to="" className="Linkcss">
      ...
      <div className="para">
        <Link to="" className="Linkcss1">
          <p style={{ textAlign: "center" }}>
            15% off SkinMedica + extra 20% off auto-replenishment. Receive a
            free gift when you spend $160+ on the brand. SHOP NOW
          </p>
        </Link>
      </div>
    </>
