...
import {getProductsSkin} from '../Redux/action'
   ...
   let arr=new Array(4).fill(0)
    ...
    useEffect(()=>{
        ...
        if(products.length===0 || selected || page){
                dispatch(getProductsSkin(selected,page))
        }
  ...
  return (
    <Box>
        ...
        <Stack display={{md:'flex'}} flexDirection={{md:"row"}}>
            ...
            <Box   width='100%'>
                <Heading as='h3' align="left" >Skin Care</Heading>
                <Text align="left" p='0.5rem 1.5rem '>4368 results</Text>
